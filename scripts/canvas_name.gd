...
const SPRITE_0001 = preload("res://assets/tilesets/tiles_spring/spring_logo.png")
const SPRITE_0002 = preload("res://assets/tilesets/tiles_summer/summer_logo.png")
const SPRITE_0003 = preload("res://assets/tilesets/tiles_autumn/autumn_logo.png")
const SPRITE_0004 = preload("res://assets/tilesets/tiles_winter/winter_logo.png")
